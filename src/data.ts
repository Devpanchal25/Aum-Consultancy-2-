...
export const TEAM: TeamMember[] = [
  {
    ...
    qualifications: ['Fellow Chartered Accountant (FCA)', 'ACCA Member (UK)', 'M.Com (Maharaja Sayajirao University of Baroda)', 'Membership No. 115201', '20 Years Experience'],
  ...
  },
  {
    ...
    qualifications: ['Fellow Chartered Accountant (FCA)', 'Membership No. 120536', '20 Years Experience', 'Operational Specialist'],
