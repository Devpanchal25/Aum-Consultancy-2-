...
const BASE_SUB_SERVICES: SubService[] = [
  ...
  },
  {
    ...
    image: '/images/individual personal new.jpg',
    iconName: 'Receipt',
    checklists: [],
    whyPartner: [],
    ...
    ctaText: 'Schedule your secure stress free personal tax filing',
    accountingSections: [
      {
        type: 'grid',
  ...
  },
  {
    ...
    image: '/images/multistatenew.jpg',
    iconName: 'Receipt',
    checklists: [],
    whyPartner: [],
