      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
        ...
        <div className="space-y-5">
          ...
          <ul className="space-y-2.5 text-xs">
            ...
            <li>
              <button onClick={() => handlePageClick('about')} className="hover:text-[#007cff] transition-colors text-slate-400 text-left font-light">About Us</button>
            </li>
            <li>
          ...
          <div className="space-y-3.5 text-xs text-slate-400 font-light">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <a href="https://wa.me/919879161400" target="_blank" rel="noreferrer" className="hover:text-green-400 transition-colors block mt-1 font-bold text-slate-300">
                  +91 9879161400 <span className="font-light text-slate-400 text-[11px] block md:inline md:ml-1.5">(CA Jitendra Tilwani)</span>
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              <Linkedin className="w-4 h-4 text-[#007cff] shrink-0 mt-0.5" />
              <div>
                <strong className="text-white block font-medium">LinkedIn:</strong>
                <a href="https://www.linkedin.com/company/aum-consultancy-india/" target="_blank" rel="noreferrer" className="hover:text-[#007cff] transition-colors block mt-1 font-medium text-slate-300">
