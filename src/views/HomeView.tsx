    ...
    <div className="pt-20">
      ...
      <section className="relative text-navy-950 overflow-hidden py-16 sm:py-24 lg:py-28 bg-white border-b border-slate-100" id="hero-section">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            >
              Scale Your Capacity & Eliminate Local Overhead. <br />
      ...
      <div className="bg-navy-950 text-white py-6 md:py-8 shadow-inner border-y border-navy-800/60 relative z-20">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm md:text-base lg:text-lg font-bold flex flex-wrap justify-center items-center gap-3 sm:gap-4 tracking-wide">
          ...
          <span className="bg-navy-900 border border-navy-800 text-indigo-200 px-3 py-1.5 rounded font-bold font-mono text-xs md:text-sm shadow-sm">US GAAP</span>
          <span className="text-[#007cff]/60 font-bold">|</span>
          <span className="bg-navy-900 border border-navy-800 text-indigo-200 px-3 py-1.5 rounded font-bold font-mono text-xs md:text-sm shadow-sm">IFRS</span>
          <span className="text-[#007cff]/60 font-bold">|</span>
          <span className="bg-navy-900 border border-navy-800 text-indigo-200 px-3 py-1.5 rounded font-bold font-mono text-xs md:text-sm shadow-sm">IRS Guidelines</span>
          <span className="text-[#007cff]/60 font-bold">|</span>
          <span className="bg-navy-900 border border-navy-800 text-indigo-200 px-3 py-1.5 rounded font-bold font-mono text-xs md:text-sm shadow-sm">HMRC Frameworks</span>
          <span className="text-[#007cff]/60 font-bold">|</span>
          <span className="bg-navy-900 border border-navy-800 text-indigo-200 px-3 py-1.5 rounded font-bold font-mono text-xs md:text-sm shadow-sm">ATO Standards</span>
        </div>
      </div>
      ...
      <section className="py-24 bg-white text-slate-800 border-t border-slate-200/60 relative overflow-hidden" id="core-values-section">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {/* Value 1 */}
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 rounded-2xl p-6 sm:p-8 flex flex-col justify-between h-full">
              <div>
                <div className="h-auto md:h-16 xl:h-20 flex items-start">
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-black">Ironclad Data Security & Compliance</h3>
                </div>
                <div className="mt-3 h-auto md:h-[100px] xl:h-[120px] flex items-start">
              ...
              <div className="pt-4 mt-6 text-xs text-slate-500 font-normal leading-relaxed">
                <strong className="text-blue-600 font-bold">• What this means for you:</strong> Your sensitive data stays within secure cloud environments using AES 256-bit encryption. We strictly adhere to international data privacy standards—including CCPA/CPRA (US), GDPR (UK), PIPEDA (Canada), and the Privacy Act (Australia)—enforcing multi-factor authentication and zero-local-storage policies.
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 rounded-2xl p-6 sm:p-8 flex flex-col justify-between h-full">
              <div>
                <div className="h-auto md:h-16 xl:h-20 flex items-start">
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-black">Absolute Quality & CPA-Grade Accuracy</h3>
                </div>
                <div className="mt-3 h-auto md:h-[100px] xl:h-[120px] flex items-start">
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-light">
              ...
              <div className="pt-4 mt-6 text-xs text-slate-500 font-normal leading-relaxed">
                <strong className="text-blue-600 font-bold">• What this means for you:</strong> Our workflows are governed strictly by US GAAP and IFRS standards. Every ledger, bank reconciliation, and tax filing undergoes a multi-tier review process to ensure absolute compliance with local authorities, including the IRS, HMRC, CRA, and ATO.
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 rounded-2xl p-6 sm:p-8 flex flex-col justify-between h-full">
              <div>
                <div className="h-auto md:h-16 xl:h-20 flex items-start">
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-black">Client-Centric Scale & Responsiveness</h3>
                </div>
                <div className="mt-3 h-auto md:h-[100px] xl:h-[120px] flex items-start">
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-light">
              ...
              <div className="pt-4 mt-6 text-xs text-slate-500 font-normal leading-relaxed">
                <strong className="text-blue-600 font-bold">• What this means for you:</strong> You get a dedicated account manager and guaranteed overlapping business hours, ensuring rapid response times via Slack, Teams, or email. We provide the flexible capacity you need to scale down overhead costs and scale up output instantly.
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 rounded-2xl p-6 sm:p-8 flex flex-col justify-between h-full">
              <div>
                <div className="h-auto md:h-16 xl:h-20 flex items-start">
                  <h3 className="font-serif text-lg sm:text-xl font-bold text-black">Radical Integrity & Process Transparency</h3>
                </div>
                <div className="mt-3 h-auto md:h-[100px] xl:h-[120px] flex items-start">
                  <p className="text-slate-600 text-xs sm:text-sm leading-relaxed font-light">
              ...
              <div className="pt-4 mt-6 text-xs text-slate-500 font-normal leading-relaxed">
                <strong className="text-blue-600 font-bold">• What this means for you:</strong> While your financial data remains entirely locked down and secure from the outside world, you retain 100% visibility into our progress through secure, real-time tracking and audit trails.
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-blue-50 border-t border-b border-slate-200/60" id="why-choose-us-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8">
            {/* Choose 1 */}
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 p-6 sm:p-8 rounded-2xl flex flex-col justify-between shadow-sm h-full">
              <div className="space-y-4 flex-1 flex flex-col">
                ...
                <div className="space-y-3 flex-1 flex flex-col justify-between mt-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed font-light">
                    We operate on strict, contractually backed Service Level Agreements (SLAs). Our overnight production cycles mean you can upload client files at the close of your business day and find them completed, verified, and sitting in your inbox the very next morning.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 p-6 sm:p-8 rounded-2xl flex flex-col justify-between shadow-sm h-full">
              <div className="space-y-4 flex-1 flex flex-col">
                ...
                <div className="space-y-3 flex-1 flex flex-col justify-between mt-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed font-light">
                    We don’t just use accounting software; we leverage advanced automation tools, cloud-based practice management platforms, and smart AI-assisted validation workflows to eliminate manual data entry errors and maximize processing speed.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 p-6 sm:p-8 rounded-2xl flex flex-col justify-between shadow-sm h-full">
              <div className="space-y-4 flex-1 flex flex-col">
                ...
                <div className="space-y-3 flex-1 flex flex-col justify-between mt-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed font-light">
                    We build a custom operational blueprint for your firm. Whether you want us directly inside your local cloud environment, managing tasks via your specific Asana/ClickUp boards, or following your firm's exact internal checklist, we adapt entirely to your rules.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/60 border-l-4 border-l-indigo-600 p-6 sm:p-8 rounded-2xl flex flex-col justify-between shadow-sm h-full">
              <div className="space-y-4 flex-1 flex flex-col">
                ...
                <div className="space-y-3 flex-1 flex flex-col justify-between mt-2">
                  ...
                  <p className="text-slate-600 text-xs leading-relaxed font-light">
                    Our teams maintain dedicated overlapping hours with the US, UK, Canada, and Australia. Your local staff can hop on a quick live Slack message or Microsoft Teams call with us during your standard workday, making collaboration completely seamless.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-slate-200/70 rounded-xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="pt-1">
                  <h4 className="text-sm sm:text-base font-bold text-[#0e1b2e]">Shlomi Golan</h4>
                  <p className="text-[11px] text-slate-500 font-semibold mt-0.5">Managing Director, Golan & Associates CPA • Boston, USA</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/70 rounded-xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="pt-1">
                  <h4 className="text-sm sm:text-base font-bold text-[#0e1b2e]">Sarah Jenkins</h4>
                  <p className="text-[11px] text-slate-500 font-semibold mt-0.5">Chief Financial Officer, Apex Brands LLC • London, UK</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/70 rounded-xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="pt-1">
                  <h4 className="text-sm sm:text-base font-bold text-[#0e1b2e]">Dr. Michael Chen</h4>
                  <p className="text-[11px] text-slate-500 font-semibold mt-0.5">Founder & Managing Director, Evergreen Medical Network • Vancouver, Canada</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-slate-200/70 rounded-xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="pt-1">
                  <h4 className="text-sm sm:text-base font-bold text-[#0e1b2e]">James MacInerney</h4>
                  <p className="text-[11px] text-slate-500 font-semibold mt-0.5">Chief Operating Officer, Vanguard Engineering Ltd • Melbourne, Australia</p>
                </div>
              </div>
            </div>
